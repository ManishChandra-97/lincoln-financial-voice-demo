...
export function scriptedConversation(scenario: DemoScenario, _mode: Mode) {
  const opening =
    'Hi, this is the Chicago Financial virtual assistant. I understand you’re calling about a potential distribution. I already have your details here, so we can jump right in, how can I help you?';
  if (scenario === 'HARDSHIP_MEDICAL')
    return [
      { assistant: opening, reply: 'I have uninsured medical expenses.' },
      {
        assistant:
          'Based on what you have described, you may qualify for a hardship withdrawal, subject to review. Sign in at chicagofinancial.com, open Withdrawals and Distributions, select Hardship Withdrawal, upload your supporting documents, and submit the request.',
